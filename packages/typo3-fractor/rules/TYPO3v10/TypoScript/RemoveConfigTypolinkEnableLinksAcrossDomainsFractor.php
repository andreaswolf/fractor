 ...
 */
final class RemoveConfigTypolinkEnableLinksAcrossDomainsFractor extends AbstractRemoveTypoScriptSettingFractor
{
    protected function getFullOptionName(): string
    {
        return 'config.typolinkEnableLinksAcrossDomains';
    }
}
