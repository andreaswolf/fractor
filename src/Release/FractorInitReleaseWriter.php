...
final class FractorInitReleaseWriter
{
    public function write(string $version): void
    {
        $typo3FractorInitFile = __DIR__ . '/../../packages/typo3-fractor/bin/typo3-fractor-init.php';
    ...
    {
        return \sprintf('Add "%s" to "%s"', $version, 'packages/typo3-fractor/bin/typo3-fractor-init.php');
    }
}
